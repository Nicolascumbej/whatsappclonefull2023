    ...
    <FlatList
      ...
      ListHeaderComponent={() => (
        ...
        >
         ...
         <Pressable key={1} 
         onPress={() => {
           navigation.navigate("New Channel");
         }}
         style={{
           flexDirection: "row",
           alignItems: "center",
       ...
       >
         ...
         />
         <Text style={{ color: "royalblue", fontSize: 16 }}>New Channel</Text>
       </Pressable>,
        <Pressable key={2} 
        onPress={() => {
          navigation.navigate("New Thread");
        }}
        style={{
          flexDirection: "row",
          alignItems: "center",
      ...
      >
        ...
        />
        <Text style={{ color: "royalblue", fontSize: 16 }}>New Thread</Text>
      </Pressable>
      ]
      )}
    />
